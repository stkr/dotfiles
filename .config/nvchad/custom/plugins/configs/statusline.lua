...
default.mode_colors = {
   ["n"] = { "NORMAL", default.colors.nord_blue },
   ["no"] = { "N-PENDING", default.colors.nord_blue },
   ["i"] = { "INSERT", default.colors.green },
   ["ic"] = { "INSERT", default.colors.green },
   ["t"] = { "TERMINAL", default.colors.green },
   ["v"] = { "VISUAL", default.colors.pink },
   ["V"] = { "V-LINE", default.colors.pink },
   [""] = { "V-BLOCK", default.colors.pink },
   ...
   ["c"] = { "COMMAND", default.colors.cyan },
   ["cv"] = { "COMMAND", default.colors.cyan },
   ["ce"] = { "COMMAND", default.colors.cyan },
...
add_table(default.left, default.empty_space)
...
add_table(default.left, default.paste_indicator)
